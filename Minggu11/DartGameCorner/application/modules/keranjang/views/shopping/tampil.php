        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <form action="<?php echo base_url() ?>keranjang/shopping/ubah_cart" method="post" name="frmShopping" id="frmShopping" class="form-horizontal" enctype="multipart/form-data">
                            <?php
                            ...
                            ?>
                                <table class="table">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            <td><img class="img-responsive" width="75px" src="<?php echo base_url() . 'assets/images/produk/' . $item['gambar']; ?>" /></td>
                                            ...
                                            <td><a href="<?php echo base_url() ?>keranjang/shopping/hapus/<?php echo $item['rowid']; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-can"></i></a></td>
                                        <?php endforeach; ?>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="4" align="right">
                                                ...
                                                <a href="<?php echo base_url() ?>keranjang/shopping/check_out" class='btn btn-sm btn-primary'>Check Out</a>
                                        </tr>
                        ...
                        <div class="modal fade" id="resetModal" tabindex="-1" aria-labelledby="newMenuModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo base_url() ?>keranjang/shopping/hapus/all" method="POST">
