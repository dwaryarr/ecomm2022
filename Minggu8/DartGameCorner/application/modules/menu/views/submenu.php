                                ...
                                <tbody>
                                    <?php foreach ($submenu as $sm) : ?>
                                        <tr>
                                            ...
                                            <td><?= $sm['is_active']; ?></td>
                                            <td>
                                                <a href="#" class="badge bg-success"><i class="fas fa-pen-to-square" data-bs-toggle="modal" data-bs-target="#editSubMenuModal"></i> Edit</a>
                                                <a href="<?= base_url('menu/deleteSubMenu/') . $sm['id']; ?>" class="badge bg-danger"><i class="fas fa-trash-can"></i> Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="input-group mt-3 mb-3">
                                        ...
                                        <!-- <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                            ...
                                            <label class="btn btn-outline-primary" for="btnradio2">Non-Active</label>
                                        </div> -->
                                    </div>
